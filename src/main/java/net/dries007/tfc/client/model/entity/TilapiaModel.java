...
public class TilapiaModel extends HierarchicalModel<FreshwaterFish>
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(2, 2).addBox(-1.0F, -2.5F, -4.0F, 2.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
            .texOffs(17, 13).addBox(0.0F, -5.5F, -3.0F, 0.0F, 9.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 22.0F, 1.0F));

        PartDefinition piece_r1 = body.addOrReplaceChild("piece_r1", CubeListBuilder.create().texOffs(1, 17).addBox(-0.1202F, -1.3841F, -0.2801F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.0F, -3.0F, 0.2566F, -0.4343F, -1.5046F));

        PartDefinition piece_r2 = body.addOrReplaceChild("piece_r2", CubeListBuilder.create().texOffs(10, 16).addBox(-0.8758F, -1.363F, -0.3181F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.0F, -3.0F, 0.3046F, 0.4368F, 1.5249F));

        PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(12, 1).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, -5.0F));

        PartDefinition leftFin = body.addOrReplaceChild("leftFin", CubeListBuilder.create().texOffs(1, 28).addBox(-2.0F, 0.0F, 0.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.0F, -3.0F, 0.6981F, 0.0F, 1.5708F));

        PartDefinition rightFin = body.addOrReplaceChild("rightFin", CubeListBuilder.create().texOffs(22, 17).addBox(0.0F, 0.0F, 0.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, 1.0F, -3.0F, 0.6981F, 0.0F, -1.5708F));

        PartDefinition tailfin = body.addOrReplaceChild("tailfin", CubeListBuilder.create().texOffs(5, 14).addBox(0.0F, -1.5F, 0.0F, 0.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, 1.0F));
