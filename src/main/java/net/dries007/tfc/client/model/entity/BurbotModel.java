...
public class BurbotModel extends HierarchicalModel<FreshwaterFish>
{
    ...
    public BurbotModel(ModelPart root)
    {
        this.root = root;
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -2.0F, -5.0F, 2.0F, 4.0F, 7.0F, new CubeDeformation(0.0F))
            .texOffs(17, 13).addBox(0.0F, -5.0F, -4.0F, 0.0F, 8.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 22.0F, 2.0F));

        PartDefinition piece_r1 = body.addOrReplaceChild("piece_r1", CubeListBuilder.create().texOffs(24, 1).addBox(-0.9881F, 0.7511F, -0.66F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, 2.0F, -4.0F, 0.3716F, -0.0194F, -1.5588F));

        PartDefinition piece_r2 = body.addOrReplaceChild("piece_r2", CubeListBuilder.create().texOffs(25, 4).addBox(-0.0447F, 0.7499F, -0.66F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 2.0F, -4.0F, 0.3705F, 0.0482F, 1.526F));

        PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(11, 0).addBox(-1.0F, -2.0F, -3.0F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, -5.0F));

        PartDefinition piece_r3 = head.addOrReplaceChild("piece_r3", CubeListBuilder.create().texOffs(1, 15).addBox(0.0F, -0.8599F, -1.4942F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.0F, -2.0F, 1.0472F, 0.0F, 0.0F));

        PartDefinition leftFin = body.addOrReplaceChild("leftFin", CubeListBuilder.create().texOffs(1, 28).addBox(-2.0F, 0.0F, 0.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.0F, -4.0F, 0.6981F, 0.0F, 1.5708F));

        PartDefinition rightFin = body.addOrReplaceChild("rightFin", CubeListBuilder.create().texOffs(22, 17).addBox(0.0F, 0.0F, 0.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, 1.0F, -4.0F, 0.6981F, 0.0F, -1.5708F));

        PartDefinition tailfin = body.addOrReplaceChild("tailfin", CubeListBuilder.create().texOffs(9, 11).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(0, 11).addBox(0.0F, -2.0F, 0.0F, 0.0F, 7.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, 2.0F));
