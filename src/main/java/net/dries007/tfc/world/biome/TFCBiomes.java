...
public final class TFCBiomes
{
    ...
    public static final BiomeExtension BARRIER_ISLANDS = register("barrier_islands", builder().heightmap(seed -> BiomeNoise.ocean(seed, -26, -12)).surface(ShoreAndOceanSurfaceBuilder.OCEAN).aquiferHeightOffset(-24).salty().type(BiomeBlendType.OCEAN).stratovolcanoes(1, -30, 180).noRivers()); // TODO: Add islands and such

    // Border Biomes
    public static final BiomeExtension OCEAN_RIDGE = register("ocean_ridge", builder().heightmap(seed -> BiomeNoise.oceanRidge(seed, -12, -20)).surface(ShoreAndOceanSurfaceBuilder.OCEAN).aquiferHeightOffset(-24).type(BiomeBlendType.OCEAN).salty().stratovolcanoes(1, -30, 180).noRivers()); // TODO: Ocean spreading ridge
