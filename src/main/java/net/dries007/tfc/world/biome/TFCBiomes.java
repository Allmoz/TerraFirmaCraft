...
public final class TFCBiomes
{
    ...
    public static final BiomeExtension COLLISIONAL_MOUNTAINS = register("collisional_mountains", builder().heightmap(seed -> BiomeNoise.ridgeMountains(seed, 18, 120, 0.6f)).surface(NormalSurfaceBuilder.ROCKY).spawnable().type(RiverBlendType.CAVE)); // Very large mountains
    public static final BiomeExtension GLACIALLY_CARVED_COLLISIONAL_MOUNTAINS = register("glacially_carved_collisional_mountains", builder().heightmap(seed -> BiomeNoise.ridgeMountains(seed, 18, 120, 0.6f)).surface(NormalSurfaceBuilder.ROCKY).spawnable().type(RiverBlendType.CAVE)); // TODO: Noise and surface builder
    public static final BiomeExtension GLACIATED_COLLISIONAL_MOUNTAINS = register("glaciated_collisional_mountains", builder().heightmap(seed -> BiomeNoise.ridgeMountains(seed, 18, 120, 0.6f)).surface(NormalSurfaceBuilder.ROCKY).spawnable().type(RiverBlendType.CAVE));
    public static final BiomeExtension ICE_SHEET_COLLISIONAL_MOUNTAINS = register("ice_sheet_collisional_mountains", builder().heightmap(seed -> BiomeNoise.ridgeMountains(seed, 18, 120, 0.6f)).surface(NormalSurfaceBuilder.ROCKY).spawnable().type(RiverBlendType.CAVE));
    ...
    // High biomes
    public static final BiomeExtension MOUNTAINS = register("mountains", builder().heightmap(seed -> BiomeNoise.ridgeMountains(seed, 10, 70, 0.8f)).surface(NormalSurfaceBuilder.ROCKY).spawnable().type(RiverBlendType.CAVE)); // High, picturesque mountains. Pointed peaks, low valleys well above sea level.
    ...
    // Lakes
    public static final BiomeExtension MOUNTAIN_LAKE = register("mountain_lake", builder().heightmap(seed -> BiomeNoise.ridgeMountains(seed, 10, 70, 0.8f)).surface(NormalSurfaceBuilder.ROCKY).carving(BiomeNoise::undergroundLakes).type(BiomeBlendType.LAKE).noRivers());
    ...
    public static final BiomeExtension VOLCANIC_MOUNTAIN_LAKE = register("volcanic_mountain_lake", builder().heightmap(seed -> BiomeNoise.ridgeMountains(seed, 10, 60, 0.8f)).surface(SimpleSurfaceBuilder.ROCKY_VOLCANIC_SOIL).stratovolcanoes(1, 12, 200).carving(BiomeNoise::undergroundLakes).type(BiomeBlendType.LAKE).noRivers());
    ...
    public static final BiomeExtension ICE_SHEET_COLLISIONAL_MOUNTAINS_EDGE = register("ice_sheet_collisional_mountains_edge", builder().heightmap(seed -> BiomeNoise.glacialCirques(seed).addConstant(39).max(BiomeNoise.glacialCirquesIceSurfaceHeight(seed).addConstant(39))).surface(IceSheetSurfaceBuilder.ICE_SHEET_MOUNTAINS).spawnable().type(RiverBlendType.CAVE).noSandyRiverShores());
