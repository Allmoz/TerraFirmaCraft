...
public final class TFCBiomes
{
    ...
    public static final BiomeExtension OCEAN_ATOLLS = register("ocean_atolls", builder().heightmap(seed -> BiomeNoise.ocean(seed, -26, -12)).surface(ShoreAndOceanSurfaceBuilder.OCEAN).aquiferHeightOffset(-24).salty().atolls(3).type(BiomeBlendType.OCEAN).noRivers()); // Ocean biome found near continents with atolls.
    public static final BiomeExtension DEEP_OCEAN_ATOLLS = register("deep_ocean_atolls", builder().heightmap(seed -> BiomeNoise.ocean(seed, -46, -30)).surface(ShoreAndOceanSurfaceBuilder.OCEAN).aquiferHeightOffset(-24).type(BiomeBlendType.OCEAN).salty().atolls(2).noRivers()); // Deep ocean biome covering most warm oceans with atolls.
