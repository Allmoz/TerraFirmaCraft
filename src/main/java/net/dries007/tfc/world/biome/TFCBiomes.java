...
public final class TFCBiomes
{
    ...
    public static final BiomeExtension OCEAN_ATOLLS = register("ocean_atolls", builder().heightmap(seed -> BiomeNoise.ocean(seed, -26, -12)).surface(ShoreAndOceanSurfaceBuilder.OCEAN).aquiferHeightOffset(-24).salty().atolls(2).type(BiomeBlendType.OCEAN).noRivers()); // Ocean biome found near continents with atolls.
