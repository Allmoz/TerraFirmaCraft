...
public final class TFCBiomes
{
    ...
    public static final BiomeExtension SUNKEN_SHIELD_VOLCANO = register("sunken_shield_volcano", builder().heightmap(seed -> BiomeNoise.sunkenShieldVolcano(seed, BiomeNoise.ancientHotSpots(seed))).surface(ShieldVolcanoSurfaceBuilder.DORMANT).tuffRings(1f / 2f, -8, 24).aquiferHeightOffset(-16).spawnable().salty().noRivers());
