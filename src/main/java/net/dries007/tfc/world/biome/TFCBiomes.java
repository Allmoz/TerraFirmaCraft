...
public final class TFCBiomes
{
    ...
    public static final BiomeExtension OCEANIC_VOLCANIC_ARC = register("oceanic_volcanic_arc", builder().heightmap(seed -> BiomeNoise.ocean(seed, -26, -12)).surface(ShoreAndOceanSurfaceBuilder.OCEAN).aquiferHeightOffset(-24).salty().type(BiomeBlendType.OCEAN).stratovolcanoes(1, -12, 200, false).noRivers()); // Ocean biome with volcanic features
    public static final BiomeExtension OCEAN_ATOLLS = register("ocean_atolls", builder().heightmap(seed -> BiomeNoise.ocean(seed, -26, -12)).surface(ShoreAndOceanSurfaceBuilder.OCEAN).aquiferHeightOffset(-24).salty().atolls(7).type(BiomeBlendType.OCEAN).noRivers()); // Ocean biome found near continents with atolls.
    public static final BiomeExtension DEEP_OCEAN_ATOLLS = register("deep_ocean_atolls", builder().heightmap(seed -> BiomeNoise.ocean(seed, -46, -30)).surface(ShoreAndOceanSurfaceBuilder.OCEAN).aquiferHeightOffset(-24).type(BiomeBlendType.OCEAN).salty().atolls(5).noRivers()); // Deep ocean biome covering most warm oceans with atolls.
    ...
    public static final BiomeExtension RIFT_VALLEY = register("rift_valley", builder().heightmap(seed -> BiomeNoise.riftValley(seed, 2, 25, false)).cinderCones(4, 0, 28).surface(NormalSurfaceBuilder.INSTANCE).spawnable().type(RiverBlendType.CAVE));
    ...
    public static final BiomeExtension CANYONS = register("canyons", builder().heightmap(seed -> BiomeNoise.canyons(seed, -2, 40)).surface(SimpleSurfaceBuilder.VOLCANIC_SOIL).cinderCones(6, 5, 36).spawnable().type(RiverBlendType.CANYON).noSandyRiverShores()); // Medium height with snake like ridges, minor volcanic activity

    // High biomes
    public static final BiomeExtension MOUNTAINS = register("mountains", builder().heightmap(seed -> BiomeNoise.ridgeMountains(seed, 10, 70, 0.5f, 140, 20)).surface(NormalSurfaceBuilder.ROCKY).spawnable().type(RiverBlendType.CAVE)); // High, picturesque mountains. Pointed peaks, low valleys well above sea level.
    ...
    public static final BiomeExtension VOLCANIC_ISLAND = register("volcanic_island", builder().heightmap(seed -> BiomeNoise.hills(seed, -5, 28)).surface(SimpleSurfaceBuilder.VOLCANIC_SOIL).aquiferHeightOffset(-8).salty().stratovolcanoes(1, 0, 200, false).type(RiverBlendType.CANYON)); // Volcanic oceanic island lowlands
    ...
    // Lakes
    public static final BiomeExtension MOUNTAIN_LAKE = register("mountain_lake", builder().heightmap(seed -> BiomeNoise.ridgeMountains(seed, 10, 70, 0.5f, 140, 20)).surface(NormalSurfaceBuilder.ROCKY).carving(BiomeNoise::undergroundLakes).type(BiomeBlendType.LAKE).noRivers());
    ...
    public static final BiomeExtension VOLCANIC_MOUNTAIN_LAKE = register("volcanic_mountain_lake", builder().heightmap(seed -> BiomeNoise.ridgeMountains(seed, 10, 60, 0.5f, 140, 20)).surface(SimpleSurfaceBuilder.ROCKY_VOLCANIC_SOIL).stratovolcanoes(1, 12, 200, false).carving(BiomeNoise::undergroundLakes).type(BiomeBlendType.LAKE).noRivers());
    public static final BiomeExtension VOLCANIC_OCEANIC_MOUNTAIN_LAKE = register("volcanic_oceanic_mountain_lake", builder().heightmap(seed -> BiomeNoise.mountains(seed, -24, 50, 1f)).surface(ShoreAndOceanSurfaceBuilder.VOLCANIC_MOUNTAINS).stratovolcanoes(1, 0, 200, false).carving(BiomeNoise::undergroundLakes).salty().type(BiomeBlendType.LAKE).noRivers());
    ...
    public static final BiomeExtension DOLINE_CANYONS = register("doline_canyons", builder().heightmap(seed -> BiomeNoise.bowlDolines(seed, BiomeNoise.canyons(seed, -2, 34), 15)).surface(SimpleSurfaceBuilder.VOLCANIC_SOIL).cinderCones(6, 14, 30).spawnable().type(RiverBlendType.CANYON).noSandyRiverShores());
    ...
    // Shield Volcanoes
    public static final BiomeExtension ACTIVE_SHIELD_VOLCANO = register("active_shield_volcano", builder().heightmap(seed -> BiomeNoise.activeShieldVolcano(seed, BiomeNoise.activeHotSpots(seed))).surface(ShieldVolcanoSurfaceBuilder.ACTIVE).cinderCones(4, 15, 25).aquiferHeightOffset(-16).spawnable().type(RiverBlendType.CAVE));
    ...
    public static final BiomeExtension ICE_SHEET_TUYAS_EDGE = register("ice_sheet_tuyas_edge", builder().heightmap(BiomeNoise::glacialBase).surface(IceSheetSurfaceBuilder.EDGE).spawnable().type(RiverBlendType.TALL_CANYON).noSandyRiverShores().tuyas(3, 0, 35, true));
    ...
    public static final BiomeExtension TUYAS = register("tuyas", builder().heightmap(BiomeNoise::drumlins).surface(NormalSurfaceBuilder.INSTANCE).spawnable().type(RiverBlendType.WIDE).tuyas(2, 0, 35, false).type(RiverBlendType.CANYON));
