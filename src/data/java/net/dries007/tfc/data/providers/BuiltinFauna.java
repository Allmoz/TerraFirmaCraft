...
public class BuiltinFauna extends DataManagerProvider<Fauna>
{
    ...
    protected void addData(HolderLookup.Provider provider)
    {
        ...
        add(Faunas.FISH.get(Fish.BLUEGILL), b -> b.temperature(-10, 15).months(FRESHWATER_FISH_MONTHS));
        add(Faunas.FISH.get(Fish.CRAPPIE), b -> b.temperature(-10, 20).months(FRESHWATER_FISH_MONTHS));
        add(Faunas.FISH.get(Fish.LAKE_TROUT), b -> b.temperature(-5, 15).minGroundwater(250).months(FRESHWATER_FISH_MONTHS));
        add(Faunas.FISH.get(Fish.RAINBOW_TROUT), b -> b.temperature(-12, 10).minGroundwater(150).months(FRESHWATER_FISH_MONTHS));
        add(Faunas.FISH.get(Fish.LARGEMOUTH_BASS), b -> b.temperature(-14, 16).groundwater(200, 500).months(FRESHWATER_FISH_MONTHS));
        add(Faunas.FISH.get(Fish.SMALLMOUTH_BASS), b -> b.temperature(-14, 16).groundwater(0, 300).months(FRESHWATER_FISH_MONTHS));
        add(Faunas.FISH.get(Fish.SALMON), b -> b.temperature(-8, 12).groundwater(250, 500).months(FRESHWATER_FISH_MONTHS));
        add(Faunas.FISH.get(Fish.ARCTIC_CHAR), b -> b.temperature(-20, -8).groundwater(150, 400).months(FRESHWATER_FISH_MONTHS));
        add(Faunas.FISH.get(Fish.NORTHERN_PIKE), b -> b.temperature(-14, -5).groundwater(150, 400).months(FRESHWATER_FISH_MONTHS));
        add(Faunas.FISH.get(Fish.PEACOCK_BASS), b -> b.temperature(12, 25).groundwater(200, 400).months(FRESHWATER_FISH_MONTHS));
        add(Faunas.FISH.get(Fish.PACU), b -> b.temperature(20, 35).groundwater(200, 500).months(FRESHWATER_FISH_MONTHS));
        add(Faunas.FISH.get(Fish.RED_PIRANHA), b -> b.temperature(22, 35).groundwater(300, 500).months(FRESHWATER_FISH_MONTHS));
        add(Faunas.FISH.get(Fish.TILAPIA), b -> b.temperature(10, 32).groundwater(0, 300).months(FRESHWATER_FISH_MONTHS));
        add(Faunas.FISH.get(Fish.SPOTTED_GUDGEON), b -> b.temperature(6, 24).groundwater(0, 250).months(FRESHWATER_FISH_MONTHS));
        add(Faunas.FISH.get(Fish.MUKSUN), b -> b.temperature(-20, -10).groundwater(250, 500).months(FRESHWATER_FISH_MONTHS));
        add(Faunas.FISH.get(Fish.BURBOT), b -> b.temperature(-16, -9).groundwater(0, 350).months(FRESHWATER_FISH_MONTHS));
