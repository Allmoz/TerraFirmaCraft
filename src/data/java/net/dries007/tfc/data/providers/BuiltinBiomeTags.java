...
public class BuiltinBiomeTags extends BiomeTagsProvider implements Accessors
{
    ...
    protected void addTags(HolderLookup.Provider provider)
    {
        ...
        tag(Tags.Biomes.IS_AQUATIC_ICY).add(
            TFCBiomes.ICE_SHEET_SHORE.key(), TFCBiomes.MELTWATER_LAKE.key(),
            TFCBiomes.SUBGLACIAL_LAKE.key()
        );
        ...
        tag(Tags.Biomes.IS_BEACH).add(
            ...
            TFCBiomes.TERRACE_UPPER.key(),            TFCBiomes.TERRACE_LOWER.key(),
            TFCBiomes.EMBAYMENTS.key(),               TFCBiomes.SHIELD_VOLCANO_SHORE.key(),
            TFCBiomes.OLD_SHIELD_VOLCANO_SHORE.key(), TFCBiomes.ICE_SHEET_SHORE.key()
        );
        ...
        tag(Tags.Biomes.IS_DEEP_OCEAN).add(
            ...
            TFCBiomes.DEEP_OCEAN_ATOLLS.key(), TFCBiomes.OCEAN_RIDGE.key()
        );
        ...
        tag(Tags.Biomes.IS_HILL).add(
            ...
            TFCBiomes.CANYONS.key(),              TFCBiomes.LOW_CANYONS.key()
        );
        ...
        tag(Tags.Biomes.IS_PLAINS).add(
            TFCBiomes.PLAINS.key(),             TFCBiomes.BURREN_PLAINS.key(),
            TFCBiomes.DOLINE_PLAINS.key(),      TFCBiomes.CENOTE_PLAINS.key(),
            TFCBiomes.TOWER_KARST_PLAINS.key(), TFCBiomes.SALT_FLATS.key(),
            TFCBiomes.MUD_FLATS.key(),          TFCBiomes.SHILIN_PLAINS.key()
        );
        ...
        tag(Tags.Biomes.IS_SANDY).add(
            ...
            TFCBiomes.BURREN_BADLANDS_TALL.key(),     TFCBiomes.BUTTES.key(),
            TFCBiomes.SHORE.key(),                    TFCBiomes.COASTAL_DUNES.key(),
            TFCBiomes.TIDAL_FLATS.key(),              TFCBiomes.ICE_SHEET_SHORE.key(),
            TFCBiomes.SEA_STACKS.key(),               TFCBiomes.SETBACK_CLIFFS.key(),
            TFCBiomes.TERRACE_UPPER.key(),            TFCBiomes.TERRACE_LOWER.key(),
            TFCBiomes.EMBAYMENTS.key(),               TFCBiomes.SHIELD_VOLCANO_SHORE.key(),
            TFCBiomes.OLD_SHIELD_VOLCANO_SHORE.key()
        );
        ...
        tag(Tags.Biomes.IS_SWAMP).add(
            ...
            TFCBiomes.INVERTED_PATTERNED_GROUND.key()
        );
        ...
        tag(Tags.Biomes.IS_WINDSWEPT).add(
            TFCBiomes.SEA_STACKS.key(),    TFCBiomes.SETBACK_CLIFFS.key(),
            TFCBiomes.DUNE_SEA.key(),      TFCBiomes.GRASSY_DUNES.key(),
            TFCBiomes.COASTAL_DUNES.key(), TFCBiomes.WHORLED_CANYONS.key()
        );
