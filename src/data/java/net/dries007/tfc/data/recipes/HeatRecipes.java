...
public interface HeatRecipes extends Recipes
{
    ...
    default void heatRecipes()
    {
        ...
        add("metal/brass_mechanism", new HeatingRecipe(Ingredient.of(TFCItems.BRASS_MECHANISMS), ItemStackProvider.empty(), new FluidStack(fluidOf(Metal.BRASS), 50), temperatureOf(Metal.BRASS), false));
