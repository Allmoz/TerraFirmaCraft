...
def make_book(rm: ResourceManager, i18n: I18n, local_instance: bool = False, reverse_translate: bool = False):
    ...
    book.category('getting_started', 'Getting Started', 'An introduction to surviving in the world of TerraFirmaCraft. How to survive the stone age and obtain your first pickaxe.', 'tfc:stone/axe/sedimentary', is_sorted=True, entries=(
        ...
        entry('building_materials', 'Building Materials', 'tfc:wattle/unstained', pages=(
            ...
            image('tfc:textures/gui/book/tutorial/wattle_stained.png', text_contents='It can then be $(thing)stained$() by using $(l:food/dye)Dye$() on it.'),
            page_break(),
    ...
    book.category('core_mechanics', 'Core Mechanics', 'An introduction to the core gameplay mechanics and systems present in TerraFirmaCraft.', 'tfc:calendar_clock', is_sorted=True, entries=(
        ...
        entry('lighting', 'Light Sources', 'tfc:candle', pages=(
            ...
            sealed_barrel_recipe('tfc:barrel/candle', 'Candles can be made by sealing $(thing)String$() in a $(l:food/barrels)Barrel$() of $(l:mechanics/lamps#tallow)Tallow$().'),
    ...
    book.category('the_world', 'The World', 'All about the natural world around you.', 'tfc:grass/entisol', is_sorted=True, entries=(
        ...
        entry('ores_and_minerals', 'Ores and Minerals', 'tfc:ore/normal_hematite', pages=(
            ...
            item_spotlight('tfc:ore/cinnabar', 'Cinnabar', text_contents='Cinnabar is a $(thing)Mineral$() which can be ground in the $(l:food/quern)Quern$() to obtain $(thing)Redstone Dust$(). It can be found in veins deep underground or high in mountains, in $(thing)Quartzite$(), $(thing)Granite$(), $(thing)Phyllite$(), and $(thing)Schist$().').link('tfc:ore/%s' % 'cinnabar').anchor('cinnabar'),
            block_spotlight('', 'Cinnabar in Quartzite.', 'tfc:ore/%s/%s' % ('cinnabar', 'quartzite')),
            item_spotlight('tfc:ore/cryolite', 'Cryolite', text_contents='Cryolite is a $(thing)Mineral$() which can be ground in the $(l:food/quern)Quern$() to obtain $(thing)Redstone Dust$(). It can be found in veins deep underground, in $(thing)Granite$(), and $(thing)Diorite$().').link('tfc:ore/%s' % 'cryolite').anchor('cryolite'),
            block_spotlight('', 'Cryolite in Granite.', 'tfc:ore/%s/%s' % ('cryolite', 'granite')),
            item_spotlight('tfc:ore/saltpeter', 'Saltpeter', text_contents='Saltpeter is a $(thing)Mineral$() which can be ground in the $(l:food/quern)Quern$(), and then used in the crafting of $(thing)Gunpowder$(). It can be found in very large flat deposits near the surface in $(l:the_world/geology#sedimentary)Sedimentary$() rocks.').link('tfc:ore/%s' % 'saltpeter').anchor('saltpeter'),
            block_spotlight('', 'Saltpeter in Shale.', 'tfc:ore/%s/%s' % ('saltpeter', 'shale')),
            item_spotlight('tfc:ore/sulfur', 'Sulfur', text_contents='Sulfur is a $(thing)Mineral$() which can be ground in the $(l:food/quern)Quern$(), and then used in the crafting of $(thing)Gunpowder$(). It is found near lava level deep underground, in sparse but large and plentiful veins, in any $(l:the_world/geology#metamorphic)Metamorphic$() or $(l:the_world/geology#igneous_intrusive)Igneous Intrusive$() rock.').link('tfc:ore/%s' % 'sulfur').anchor('sulfur'),
            block_spotlight('', 'Sulfur in Gabbro.', 'tfc:ore/%s/%s' % ('sulfur', 'gabbro')),
            item_spotlight('tfc:ore/sylvite', 'Sylvite', text_contents='Sylvite is a $(thing)Mineral$() which can be ground in the $(l:food/quern)Quern$(), and then used as a $(l:food/fertilizers)Fertilizer$(). It can be found in very large flat deposits near the surface in $(thing)Shale$(), $(thing)Claystone$() and $(thing)Chert$().').link('tfc:ore/%s' % 'sylvite').anchor('sylvite'),
            block_spotlight('', 'Sylvite in Chert.', 'tfc:ore/%s/%s' % ('sylvite', 'chert')),
            item_spotlight('tfc:ore/borax', 'Borax', text_contents='Borax is a $(thing)Mineral$() which can be ground in the $(l:food/quern)Quern$() to produce $(l:metalworking/flux)Flux$(). It can be found in very large flat deposits near the surface in $(thing)Claystone$(), $(thing)Limestone$(), and $(thing)Shale$().').link('tfc:ore/%s' % 'borax').anchor('borax'),
            ...
            item_spotlight('tfc:ore/halite', 'Halite', text_contents='Halite is a $(thing)Mineral$() which can be ground in the $(l:food/quern)Quern$() to make $(thing)Salt$(), which is an important $(l:food/decay#salting)Preservative$(). It can be found in very large flat deposits near the surface in $(l:the_world/geology#sedimentary)Sedimentary$() rocks.').link('tfc:ore/%s' % 'halite').anchor('halite'),
            ...
            item_spotlight('tfc:ore/lapis_lazuli', 'Lapis Lazuli', text_contents='Lapis Lazuli is a decorative $(l:mechanics/gems)Gemstone$() which can be used to make $(l:food/dye)Blue Dye$(). It can be found in large, but sparse veins in $(thing)Limestone$() and $(thing)Marble$(), between y=-20 and y=80.').link('tfc:ore/%s' % 'lapis_lazuli').anchor('lapis_lazuli'),
    ...
    book.category('metalworking', 'Metalworking', 'Processing more advanced types of metals, from bronzes to steels.', 'tfc:metal/anvil/bronze', is_sorted=True, entries=(
        ...
        entry('flux', 'Flux', 'tfc:powder/flux', pages=(
            text('Flux is a powder which is required for $(l:metalworking/anvils#welding)Welding$() and also used as a catalyst in a $(l:metalworking/blast_furnace)Blast Furnace$(). Flux can be obtained by grinding specific items in a $(l:food/quern)Quern$().$(br2)Flux can be obtained in a number of ways, one of which is from its native ore, $(l:the_world/ores_and_minerals#borax)Borax$().').link('tfc:powder/flux'),
            quern_recipe('tfc:quern/powder/flux', 'Some rocks - $(thing)Limestone$(), $(thing)Dolomite$(), $(thing)Chalk$(), or $(thing)Marble$() - can also be used as flux, after being ground in a $(l:food/quern)Quern$(). Other items, including $(thing)Scutes$(), $(thing)Clams$(), $(thing)Mollusks$(), and the edible remains of $(l:the_world/wild_animals#shellfish)Shellfish$() can also be used to create flux.'),
        )),
        ...
        entry('fire_clay', 'Fire Clay', 'tfc:fire_clay', pages=(
            ...
            crafting('tfc:crafting/fire_clay', text_contents='Fire clay is made from $(l:the_world/ores_and_minerals#graphite)graphite$() powder, crushed in a $(l:food/quern)quern$(), as well as $(l:the_world/ores_and_minerals#kaolinite)kaolinite$() powder'),
    ...
    book.category('food', 'Food and Agriculture', 'Everything to know about farming crops and raising animals.', 'tfc:food/maize_bread_jam_sandwich', is_sorted=True, entries=(
        ...
        entry('pets', 'Pets', 'minecraft:lead', pages=(
            ...
            text('Pets recognize a certain player as their $(thing)Owner$(). To become a pet\'s owner, feed it to raise its familiarity above 15%%. Pets will only obey commands that come from their owner.$(br2)Clicking on a pet with $(l:food/dye)dye$() changes its collar color.'),
        ...
        entry('crops', 'Crops', 'tfc:food/wheat', pages=(
            ...
            text(f'{detail_crop("papyrus")}Papyrus is a two block tall crop. Papyrus seeds can be planted on farmland, will grow two blocks tall, and will produce $(l:food/papermaking)Papyrus$() and $(thing)Papyrus Seeds$() as a product.', title='Papyrus').link('tfc:seeds/papyrus').link('tfc:papyrus').anchor('papyrus'),
            multimultiblock('', *[multiblock('', '', False, (('X',), ('Y',), ('Z',), ('0',)), {
        ...
        entry('decay', 'Preservation', 'minecraft:rotten_flesh', pages=(
            ...
            quern_recipe('tfc:quern/powder/salt', 'One way of getting salt is through $(l:food/quern)grinding$() $(l:the_world/ores_and_minerals#halite)Halite$(), which is a mineral.'),
            ...
            text('$(thing)Vinegar Preservation$() is a way of making fruits, veggies, and meat last longer.$(br2)$(thing)Vinegar$() is made in a $(l:food/barrels)Barrel$(), by sealing a fruit with 250mB of Alcohol. To preserve food in vinegar it must first be $(thing)Pickled$() in $(thing)Brine$(). Brine is made in a barrel with 1 part $(thing)Vinegar$() and 9 parts $(thing)Salt Water$().').anchor('vinegar'),
        ...
        entry('bowls', 'Bowls', 'tfc:ceramic/bowl', pages=(
            text('$(thing)Bowls$() are a versatile tool which can be used to make $(l:food/salad)Salads$(), to make $(l:food/pot)Soups$(), to $(l:food/decay#salting)Salt$() meat, or to apply $(thing)Powder$() to $(l:mechanics/glassworking_applications#coloring)Glass$() in order to change the resulting glass\'s color.$(br2)Bowls can be made both from $(thing)Ceramic$(), by knapping a bowl out of clay, and then firing them.'),
            ...
            crafting('minecraft:bowl', text_contents='Bowls can also be made out of wood via crafting them together with $(thing)Glue$()$(br2)$(thing)Glue$() can be made by soaking $(thing)Bone Meal$() in a barrel of $(l:food/barrels#limewater)Limewater$().', title='Wooden Bowls').link('minecraft:bowl'),
            sealed_barrel_recipe('tfc:barrel/glue', 'Bowls can also be placed on the ground like blocks. When placed, they can be filled with any type of $(thing)Powder$() - the results of grinding ores, minerals, or gems in the $(l:food/quern)Quern$().'),
        ...
        entry('bread', 'Bread', 'tfc:food/barley_bread', pages=(
            ...
            quern_recipe('tfc:quern/food/oat_flour', 'Grain must then be ground in a $(l:food/quern)Quern$() to make flour.'),
        ...
        entry('dairy', 'Dairy Products', 'tfc:food/cheese', pages=(
            ...
            text('To start the $(thing)Cheesemaking$() process, add $(thing)Milk$() and $(thing)Vinegar$() in a $(l:food/barrels)Barrel$() at a ratio of 9:1. This is easiest done by filling 9 buckets of milk in a barrel, and adding a single bucket of vinegar. This produces $(thing)Milk Vinegar$().').link('tfc:food/cheese'),
        ...
        entry('barrels', 'Barrels', 'tfc:wood/barrel/palm', pages=(
            ...
            instant_barrel_recipe('tfc:barrel/limewater', '$(bold)Limewater$() is made by adding $(l:metalworking/flux)Flux$() to a barrel of $(thing)Water$(). A single $(l:metalworking/flux)Flux$() is required for every $(thing) 500 mB$() of $(thing)Water$(). $(thing)Limewater$() is a reagent used in $(l:food/leather_making)Leather Making$(), and is used to make $(thing)Mortar$().').anchor('limewater'),
        ...
        entry('quern', 'Quern', 'tfc:quern', pages=(
            text('The $(thing)Quern$() is a device for grinding items. It can make powders, $(l:food/dye)dyes$(), and some other items. It is assembled from a $(thing)Base$() and $(thing)Handstone$().$(br2)The Quern can also be connected to a $(l:mechanics/mechanical_power#quern)Mechanical Power$() network.'),
            ...
            quern_recipe('tfc:quern/red_dye', '$(l:food/dye)Dye$() can be obtained from various flowers.'),
        ...
        entry('leather_making', 'Leather Making', 'minecraft:leather', pages=(
            text('$(thing)Leather$() is a sturdy material formed from animal hides. It is required to craft $(l:mechanics/armor)Armor$(), $(thing)Saddles$(), or a $(l:metalworking/bellows)Bellows$(). $()Raw Hides$() must be treated through several processes: $(l:food/leather_making#soaking)soaking$(), $(l:food/leather_making#scraping)scraping$(), $(l:food/leather_making#preparing)preparing$(), and $(l:food/leather_making#tanning)tanning$() to turn them into $(thing)Leather$().'),
            ...
            text('Leather making will require several materials and tools. You will need:$(br)$(li)$(l:food/barrels#limewater)Limewater$() - a solution of $(l:metalworking/flux)Flux$() in $(thing)Water$()$(li)Water$(li)$(l:food/barrels#tannin)Tannin$() - an acidic solution made from the bark of some trees.$(li)$(thing)Raw Hides$()$(br2)With all that on hand, you are ready to begin the leather working process.'),
            sealed_barrel_recipe('tfc:barrel/medium_soaked_hide', 'First, raw hides must be $(thing)soaked$() to clean them and loosen unwanted material before processing. This can be done by sealing some $(thing)Raw Hide$() in a $(l:food/barrels#limewater)Barrel of Limewater$() for at least six hours.').anchor('soaking').link('tfc:small_soaked_hide', 'tfc:medium_soaked_hide', 'tfc:large_soaked_hide'),
            ...
            sealed_barrel_recipe('tfc:barrel/medium_prepared_hide', 'After scraping, $(thing)Scraped Hides$() must be sealed in a $(l:food/barrels)Barrel$() of $(thing)Water$() for at least six hours, for one final cleaning before tanning.').anchor('preparing').link('tfc:small_prepared_hide', 'tfc:medium_prepared_hide', 'tfc:large_prepared_hide'),
            sealed_barrel_recipe('tfc:barrel/medium_leather', 'Finally, $(thing)Prepared Hides$() must be sealed in a $(l:food/barrels#tannin)Barrel of Tannin$(), which is an acidic chemical compound that helps to convert the hide to $(thing)Leather$(). After another six hours, you can remove the $(thing)Leather$() from the barrel.').anchor('tanning').link('minecraft:leather'),
        )),
        entry('weaving', 'Weaving', 'tfc:spindle', pages=(
            ...
            loom_recipe('tfc:loom/white_wool', '$(thing)Wool Cloth$() can be re-woven into $(thing)Wool Blocks$(). Wool blocks can be $(l:food/dye)dyed$().').link('minecraft:white_wool'),
        ...
        entry('papermaking', 'Papermaking', 'tfc:unrefined_paper', pages=(
            text('$(thing)Paper$() is either made from the processed stalk of the $(l:food/crops#papyrus)Papyrus$() crop, or from $(l:food/papermaking#parchment)Animal Hides$(). Paper is useful for written materials like $(thing)Books$() and $(thing)Maps$().'),
            crafting('tfc:crafting/papyrus_strip', text_contents='Papyrus must first be cut into strips with a $(thing)Knife$()'),
            sealed_barrel_recipe('tfc:barrel/soaked_papyrus_strip', 'Then, papyrus strips are soaked in a $(l:food/barrels)Barrel$() of $(thing)Water$().'),
            loom_recipe('tfc:loom/unrefined_paper', 'Then, soaked papyrus strips are woven together in a loom to make $(thing)Unrefined Paper$(). Finally, it must be placed on a log and $(l:food/leather_making#scraping)Scraped$() to make $(thing)Paper$().'),
            ...
            page_break(),
            text('$(thing)Parchment Paper$() starts with a scraped hide. Review the $(l:food/leather_making)leather making chapter$() to learn how to make it. Parchment requires treatment with a few different items. First, $(thing)Pumice$() is needed. Pumice is found on the ground near $(l:the_world/geology)Volcanoes$(), or from $(l:metalworking/sluices)Sluicing$() or $(l:getting_started/panning)Panning$() ore deposits with Andesite, Rhyolite, or Dacite in them.', title='Parchment').anchor('parchment'),
        ...
        entry('dye', 'Dye', 'minecraft:red_dye', pages=(
            text('All 16 vanilla $(thing)Dye Colors$() can be obtained as items. Most flowers and other colorful plants can be ground into dye using a $(l:food/quern)Quern$(). Powders of $(l:the_world/ores_and_minerals)metal ores$() can be crafted directly into dye. $(l:the_world/ores_and_minerals#graphite)Graphite$(), $(l:the_world/ores_and_minerals#kaolinite)Kaolinite$(), $(l:the_world/ores_and_minerals#sylvite)Sylvite$(), $(l:the_world/ores_and_minerals#lapis_lazuli)Lapis$(), Coke, and Charcoal powder can be crafted into dye as well.'),
            item_spotlight('tfc:bucket/red_dye', 'Dye Liquids', text_contents='Dyes can also be made into fluids. A dye item and 1000mB of $(item)Water$() boiled in a $(l:food/pot)Pot$() produces the same amount of $(thing)Dye Fluid$(). Dye fluids are used in $(l:food/barrels)Barrels$() to color items.'),
            ...
            text('$(li)$(item)Black Dye$() is used for $(l:mechanics/scribing_table)Scribing Tables$().$(li)$(item)Red Dye$() is used for $(l:mechanics/powderkegs)Powderkegs$(). $(li)Unfired $(l:food/decay#small_vessels)Small Vessels$() and $(l:food/decay#large_vessels)Large Vessels$() can be dyed$().', title='Miscellaneous'),
            empty_last_page()
        )),
    ))

    book.category('mechanics', 'Advanced Mechanics', 'Advanced and miscellaneous sections of the tech tree.$(br2)$(br)$(bold)Note:$() you can search entries simply by starting to type anywhere!', 'tfc:metal/helmet/blue_steel', entries=(
        ...
        entry('glassworking', 'Glassworking', 'tfc:silica_glass_bottle', pages=(
            ...
            text('$(bold)Flatten$()$(br)Use the $(thing)Blowpipe$() while holding a $(l:mechanics/glassworking#paddle)Paddle$() in your offhand.$(br2)$(bold)Pinch$()$(br)Use the $(thing)Blowpipe$() while holding $(l:mechanics/glassworking#jacks)Jacks$() in your offhand.$(br2)$(bold)Saw$()$(br)Use the $(thing)Blowpipe$() while holding a $(l:mechanics/glassworking#saw)Gem Saw$() in your offhand.$(br2)$(bold)Roll$()$(br)Use the $(thing)Blowpipe$() with a $(l:food/weaving#wool_cloth)Wool Cloth$() in your offhand.'),
        )),
        entry('glassworking_applications', 'Glass Products', 'minecraft:glass', pages=(
            ...
            page_break(),
            text('Glass has a natural color based on the type of $(l:mechanics/glassworking)Glass Batch$() that was used. Other colors can be made using a $(l:food/bowls)Bowl$().$(br2)To use, place the $(l:food/bowls)Bowl$() on the ground, then $(item)$(k:key.use)$() the required $(thing)Powder$(). Before $(thing)Pouring$(), use the $(thing)Blowpipe$() on the bowl to add the powder to the batch.', title='Coloring Glass').anchor('coloring'),
        ...
        entry('scribing_table', 'Scribing Table', 'minecraft:black_dye', pages=(
            text('The $(thing)Scribing Table$() is used to rename items. It requires $(l:food/dye)Black Dye$() to rename items, which can be supplied as the traditional dye item or as a bucket of dye fluid.'),
        ...
        entry('sewing_table', 'Sewing Table', 'tfc:wood/sewing_table/oak', pages=(
            text('The $(thing)Sewing Table$() is used to produce banner patterns and smithing templates. It requires $(l:food/weaving#wool_cloth)Wool Cloth$(), $(l:food/weaving#burlap_cloth)Burlap Cloth$(), String or Yarn, as well as a Needle.'),
        ...
        entry('advanced_building_materials', 'Advanced Materials', 'tfc:brick/rhyolite', pages=(
            ...
            text('Plaster can be $(l:food/dye)dyed$() in a $(l:food/barrels)Barrel$() of dye into any color. Raw Plaster blocks can also be $(l:metalworking/chisel)chiseled$() into $(thing)Polished Plaster$() using the $(thing)Smooth$() chisel mode, or crafted into stairs, slabs, or walls.', title='Plaster Decorations'),
            ...
            page_break(),
            text('$(thing)Stone Bricks$() can be made using a $(l:metalworking/chisel)Chisel$() with some individual loose rocks. It then requires $(thing)Mortar$() in order to form a strong building block.$(br2)Mortar can be made by adding $(thing)Sand$() to a barrel of $(l:food/barrels#limewater)Limewater$().', title='Bricks and Mortar').anchor('bricks_and_mortar'),
        ...
        entry('armor', 'Armor', 'tfc:metal/chestplate/copper', pages=(
            text('$(thing)Armor$() provides protection against attacks from predators and monsters. The quality of armor scales with the tier of the $(thing)Metal$(), with $(l:food/leather_making)Leather$() being the weakest and $(l:metalworking/steel)Colored Steels$() being the strongest.'),
            knapping('tfc:knapping/leather_chestplate', 'Leather armor is $(thing)Knapped$() from $(l:food/leather_making)Leather$(). It does not last long, but provides some decent protection if you have a full suit.').link(*['minecraft:leather_%s' % g for g in ('helmet', 'chestplate', 'leggings', 'boots')]),
        ...
        entry('powderkegs', 'Powderkegs', 'tfc:powderkeg', pages=(
            ...
            block_spotlight('The Powderkeg', 'Similar to the $(l:food/barrels)Barrel$(), the powderkeg is a device which can be sealed and unsealed with $(item)$(k:key.use)$(). Only sealed powderkegs may be ignited.', 'tfc:powderkeg[sealed=true]'),
        ...
        entry('gems', 'Gems', 'tfc:gem/opal', pages=(
            ...
            item_spotlight('#tfc:gem_powders', text_contents='Gems can be ground into powder using a $(l:food/quern)Quern$(). Gem powders are particularly useful in $(l:mechanics/glassworking_applications#coloring)Coloring Glass$().'),
        ...
        entry('lamps', 'Lamps', 'tfc:metal/lamp/bismuth_bronze', pages=(
            ...
            crafting('tfc:crafting/metal/lamp/bronze', text_contents='Lamps are smithed in the $(l:metalworking/anvils)Anvil$() and crafted with $(l:mechanics/glassworking_applications#lamp_glass)Lamp Glass$() to be completed.'),
            ...
            text('Boil the $(thing)Olive Paste$() with $(thing)Water$() in a $(l:food/pot)Pot$() to make $(thing)Olive Oil Water$(). Seal that in a $(l:food/barrels)Barrel$() with your $(thing)Jute Net$() to produce $(thing)Olive Oil$(). Olive oil burns for 6 in-game hours for every unit of fluid.'),
        ...
        entry('mechanical_power', 'Mechanical Power', 'tfc:wood/water_wheel/oak', pages=(
            ...
            text('One device that can be connected to the mechanical network is a $(l:food/quern)Quern$(), simply by placing a vertical-facing axle above the Quern. While connected, the Quern cannot be turned manually, instead it will grind items automatically as the axle above rotates.$(br2)The Quern will grind faster if the axle above spins faster.', title='Quern Automation').anchor('quern'),
            ...
            text('$(l:food/weaving#power_loom)Weaving$() can be automated through the use of a $(l:food/weaving#power_loom)Power Loom$(). Read that chapter for more information.'),
            empty_last_page()
        )),
