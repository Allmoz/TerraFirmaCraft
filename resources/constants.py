...
DEFAULT_LANG = {
    ...
    **dict(('metal.tfc.%s' % metal, lang(metal)) for metal in METALS.keys()),
    ...
    'tfc.config.server.camelAdulthoodDays': 'Adulthood Days',
    'tfc.config.server.camelChildCount': 'Child Count',
    'tfc.config.server.camelEatsRottenFood': 'Eats Rotten Food',
    'tfc.config.server.camelFamiliarityCap': 'Familiarity Cap',
    'tfc.config.server.camelGestationDays': 'Gestation Days',
    'tfc.config.server.camelUses': 'Uses',
