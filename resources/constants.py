...
DEFAULT_LANG = {
    ...
    **dict(('subtitles.entity.tfc.%s.hurt' % fish, '%s hurts' % fish.title().replace('_', ' ')) for fish in (*SIMPLE_FRESHWATER_FISH, 'manatee', 'jellyfish')),
    ...
    # Creative Tabs
    'tfc.creative_mode_tab.tfc_0building_blocks': 'TFC Building Blocks',
    'tfc.creative_mode_tab.tfc_1colored_blocks': 'TFC Colored Blocks & Items',
    'tfc.creative_mode_tab.tfc_2natural_blocks': 'TFC Natural Blocks',
    'tfc.creative_mode_tab.tfc_3flora_crops': 'TFC Flora & Crops',
    'tfc.creative_mode_tab.tfc_4functional_blocks': 'TFC Functional Blocks',
    'tfc.creative_mode_tab.tfc_5tools_utilities': 'TFC Tools & Utilities',
    'tfc.creative_mode_tab.tfc_6combat': 'TFC Combat',
    'tfc.creative_mode_tab.tfc_7foods_drinks': 'TFC Food & Drinks',
    'tfc.creative_mode_tab.tfc_8metals_ingredients': 'TFC Ingredients & Metals',
    'tfc.creative_mode_tab.tfc_9spawn_eggs': 'TFC Spawn Eggs',
    # Containers
